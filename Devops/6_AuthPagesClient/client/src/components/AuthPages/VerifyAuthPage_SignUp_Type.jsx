...
const VerifyAuthPage_SignUp_Type = () => {
    ...
    const continueButtonRef_AccountUser = useRef();
    const continueButtonRef_AccountRestaurant = useRef();
    ...
    useEffect(() => {
        ...
        if (currentTheme) {
            ...
            continueButtonRef_AccountUser?.current?.style?.setProperty('--content-continue-button-backgroundColor', themesStyle[currentTheme]?.content?.continueButton_BackgroundColor)
            continueButtonRef_AccountUser?.current?.style?.setProperty('--content-continue-button-backgroundColorHover', themesStyle[currentTheme]?.content?.continueButton_BackgroundColor_Hover)
            continueButtonRef_AccountRestaurant?.current?.style?.setProperty('--content-continue-button-backgroundColor', themesStyle[currentTheme]?.content?.continueButton_BackgroundColor)
            continueButtonRef_AccountRestaurant?.current?.style?.setProperty('--content-continue-button-backgroundColorHover', themesStyle[currentTheme]?.content?.continueButton_BackgroundColor_Hover)
    ...
    useEffect(() => {
        ...
        if (!searchParams.get('sessionsecret')) {
            navigate(`/va/signup/va`, { replace: true })
        }
    ...
    const onClickSubmit_Type_RestaurantAccount = async () => {
        setIsLoading(true)
        navigate(`/va/signup/restaurant?email=${btoa(email)}&sessionsecret=${btoa(sessionSecret)}&signuptype=${btoa('restaurant')}`, { replace: false })
        setIsLoading(false)

    }
    const onClickSubmit_Type_UserAccount = async () => {
        setIsLoading(true)
        navigate(`/va/signup/user?email=${btoa(email)}&sessionsecret=${btoa(sessionSecret)}&signuptype=${btoa("user")}`, { replace: false })
        setIsLoading(false)
    }
                    ...
                    <div className={VerifyAuthPageCss.ContentContainer}>
                        <div className={VerifyAuthPageCss.ContentBlock}>
                            ...
                            <div ref={authContentRef} className={VerifyAuthPageCss.Content}>
                                <div className={classNames(VerifyAuthPageCss.textSizeLarge, VerifyAuthPageCss.textBold)}>{languagesTitle?.SignUpType[currentLanguage]}</div>
                                ...
                                <div flexdirection='row' className={classNames(VerifyAuthPageCss.InputBlock, VerifyAuthPageCss?.AccountTypeBlock)}>
                                    <div flexdirection="column" tabIndex={2} flexjustify='space-around' flexalign="center" onFocus={onFocusTab} onClick={onClickSubmit_Type_UserAccount} onKeyDown={(event) => { if (event?.code == 'Space' || event?.code == 'Enter') { onClickSubmit_Type_UserAccount() } }} ref={continueButtonRef_AccountUser} className={classNames(VerifyAuthPageCss?.ContinueButton, VerifyAuthPageCss?.Animation_Shake1deg)}>
                                        {isLoading ?
                                            <img src={loadingImage} width={'30px'} height={'30px'}></img> :
                                            < >
                                                <ul className={classNames(VerifyAuthPageCss.textSizeSmall, VerifyAuthPageCss.AccountDetailsUl)}>

                                                    <li>Explore Restaurant</li>
                                                ...
                                                <div className={classNames(VerifyAuthPageCss.textSizeMedium, VerifyAuthPageCss?.textBold)}>
                                                    {languagesTitle?.UserAccount[currentLanguage]}
                                                </div>
                                            </>
                                        }

                                    </div>
                                    <div flexdirection="column" tabIndex={3} flexjustify='space-around' flexalign="center" onFocus={onFocusTab} onClick={onClickSubmit_Type_RestaurantAccount} onKeyDown={(event) => { if (event?.code == 'Space' || event?.code == 'Enter') { onClickSubmit_Type_RestaurantAccount() } }} ref={continueButtonRef_AccountRestaurant} className={classNames(VerifyAuthPageCss?.ContinueButton, VerifyAuthPageCss?.Animation_Shake1deg)}>
                                        {isLoading ?
                                            <img src={loadingImage} width={'30px'} height={'30px'}></img> :
                                            < >
                                                <ul className={classNames(VerifyAuthPageCss.textSizeSmall, VerifyAuthPageCss.AccountDetailsUl)}>
                                                    ...
                                                    <li>Advertisment Feature</li>
                                                    <li>Paid Account</li>
                                                </ul>
                                                <div className={classNames(VerifyAuthPageCss.textSizeMedium, VerifyAuthPageCss?.textBold)}>
                                                    {languagesTitle?.RestaruantAcccount[currentLanguage]}
                                                </div>
                                            </>
                                        }
                    ...
                    <div className={VerifyAuthPage_Portait_Css.ContentContainer}>
                        <div className={VerifyAuthPage_Portait_Css.ContentBlock}>
                            ...
                            <div ref={authContentRef} className={VerifyAuthPage_Portait_Css.Content}>
                                <div className={classNames(VerifyAuthPage_Portait_Css.textSizeLarge, VerifyAuthPage_Portait_Css.textBold)}>{languagesTitle?.SignUpType[currentLanguage]}</div>
                                ...
                                <div flexdirection='row' className={classNames(VerifyAuthPage_Portait_Css.InputBlock, VerifyAuthPage_Portait_Css?.AccountTypeBlock)}>
                                    <div flexdirection="column" tabIndex={2} flexjustify='space-around' flexalign="center" onFocus={onFocusTab} onClick={onClickSubmit_Type_UserAccount} onKeyDown={(event) => { if (event?.code == 'Space' || event?.code == 'Enter') { onClickSubmit_Type_UserAccount() } }} ref={continueButtonRef_AccountUser} className={classNames(VerifyAuthPage_Portait_Css?.ContinueButton, VerifyAuthPage_Portait_Css?.Animation_Shake1deg)}>
                                        {isLoading ?
                                            <img src={loadingImage} width={'30px'} height={'30px'}></img> :
                                            < >
                                                <ul className={classNames(VerifyAuthPage_Portait_Css.textSizeSmall, VerifyAuthPage_Portait_Css.AccountDetailsUl)}>
                                                ...
                                                <div className={classNames(VerifyAuthPage_Portait_Css.textSizeMedium, VerifyAuthPage_Portait_Css?.textBold)}>
                                                    {languagesTitle?.UserAccount[currentLanguage]}
                                                </div>
                                            </>
                                        }
                                    ...
                                    <div flexdirection="column" tabIndex={3} flexjustify='space-around' flexalign="center" onFocus={onFocusTab} onClick={onClickSubmit_Type_RestaurantAccount} onKeyDown={(event) => { if (event?.code == 'Space' || event?.code == 'Enter') { onClickSubmit_Type_RestaurantAccount() } }} ref={continueButtonRef_AccountRestaurant} className={classNames(VerifyAuthPage_Portait_Css?.ContinueButton, VerifyAuthPage_Portait_Css?.Animation_Shake1deg)}>
                                        {isLoading ?
                                            <img src={loadingImage} width={'30px'} height={'30px'}></img> :
                                            < >
                                                <ul className={classNames(VerifyAuthPage_Portait_Css.textSizeSmall, VerifyAuthPage_Portait_Css.AccountDetailsUl)}>
                                                ...
                                                <div className={classNames(VerifyAuthPage_Portait_Css.textSizeMedium, VerifyAuthPage_Portait_Css?.textBold, VerifyAuthPage_Portait_Css?.whiteSpaceNormal)}>
                                                    {languagesTitle?.RestaruantAcccount[currentLanguage]}
                                                </div>
                                            </>
                                        }
...
export default VerifyAuthPage_SignUp_Type;